...
public class SeatUI  extends JFrame implements ActionListener{
	...
	public SeatUI(TicketingMenuUI tui) {
		...
		//		departmentLabel.setFont(new Font("맑은고딕",Font.BOLD,15));
		departmentLabel.setBounds(10,15,100,30);

		arrivalLabel=new JLabel("도착지 :");
		//		arrivalLabel.setFont(new Font("맑은고딕",Font.BOLD,15));
		...
		//		timeLabel.setFont(new Font("맑은고딕",Font.BOLD,15));
		timeLabel.setBounds(10,105,100,30);

		seatNumLabel=new JLabel("좌석 선택 수 :");
		//		seatNumLabel.setFont(new Font("맑은고딕",Font.BOLD,15));
		...
		//	wonLabel.setFont(new Font("맑은고딕",Font.BOLD,15));
