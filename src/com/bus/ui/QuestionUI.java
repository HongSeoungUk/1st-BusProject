...
public class QuestionUI extends JFrame implements ActionListener{
	...
	public QuestionUI() {
		...
		/*Q1pan.setBackground(Color.cyan); 
		Q2pan.setBackground(Color.gray);
		Q3pan.setBackground(Color.cyan);
		Q4pan.setBackground(Color.gray);
		Q5pan.setBackground(Color.cyan);*/
		
		
		// 각 패널들의 여백으로 라벨, 버튼의 균형 맞추기
		/*Q1pan.setBorder(BorderFactory.createEmptyBorder(30,0,30,30));
		Q2pan.setBorder(BorderFactory.createEmptyBorder(30,0,30,30));
		Q3pan.setBorder(BorderFactory.createEmptyBorder(30,0,30,30));
		Q4pan.setBorder(BorderFactory.createEmptyBorder(30,0,30,30));
		Q5pan.setBorder(BorderFactory.createEmptyBorder(30,0,30,30));*/
		...
		/*Q1Label = new JLabel("q1. 환불은 언제까지 가능한가요?"); // 1번째 질문
		Q2Label = new JLabel("q2."); // 2번째 질문
		Q3Label = new JLabel("q3."); // 3번째 질문
		Q4Label = new JLabel("q4."); // 4번째 질문
		Q5Label = new JLabel("q5."); // 5번째 질문*/
		...
		q5Btn  = new JButton("Q5. 갑자기버스가 취소 되었는데 왜 그런가요?");
		...
		/*Q1Label.setFont(new Font("HYGraphic",Font.BOLD,17));
		Q2Label.setFont(new Font("HYGraphic",Font.BOLD,17));
		Q3Label.setFont(new Font("HYGraphic",Font.BOLD,17));
		Q4Label.setFont(new Font("HYGraphic",Font.BOLD,17));
		Q5Label.setFont(new Font("HYGraphic",Font.BOLD,17));*/
